...
interface CalculateGsnCapableSelectorInterface extends ethers.utils.Interface {
  functions: {
...
export class CalculateGsnCapableSelector extends Contract {
  ...
  interface: CalculateGsnCapableSelectorInterface;
