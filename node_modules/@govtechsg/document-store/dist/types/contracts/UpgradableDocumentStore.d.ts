...
interface UpgradableDocumentStoreInterface extends ethers.utils.Interface {
  functions: {
...
export class UpgradableDocumentStore extends Contract {
  ...
  interface: UpgradableDocumentStoreInterface;
  ...
  callStatic: {
    ...
    revoke(document: BytesLike, overrides?: CallOverrides): Promise<boolean>;
