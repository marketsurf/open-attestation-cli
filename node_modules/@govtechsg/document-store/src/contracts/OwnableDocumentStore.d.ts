...
interface OwnableDocumentStoreInterface extends ethers.utils.Interface {
  functions: {
...
export class OwnableDocumentStore extends Contract {
  ...
  interface: OwnableDocumentStoreInterface;
