 ...
 */
export declare const ENCRYPTION_PARAMETERS: {
    algorithm: "AES-GCM";
    keyLength: number;
    ivLength: number;
    tagLength: number;
 ...
 */
export declare const generateEncryptionKey: (keyLengthInBits?: number) => string;
export declare const encodeDocument: (document: string) => string;
export declare const decodeDocument: (encoded: string) => string;
 ...
 */
export declare const encryptString: (document: string, key?: string | undefined) => IEncryptionResults;
/**
 ...
 */
export declare const decryptString: ({ cipherText, tag, iv, key, type }: IEncryptionResults) => string;
