...
var obfuscateData = function (_data, fields) {
    ...
    var dataToObfuscate = (0, flatten_1.flatten)((0, lodash_1.pick)(data, fieldsToRemove));
    var obfuscatedData = Object.keys(dataToObfuscate).map(function (k) {
        var obj = {};
        obj[k] = dataToObfuscate[k];
        return (0, utils_1.toBuffer)(obj).toString("hex");
    });
...
var obfuscateDocument = function (document, fields) {
    ...
    var _c = (0, exports.obfuscateData)(existingData, fields), data = _c.data, obfuscatedData = _c.obfuscatedData;
