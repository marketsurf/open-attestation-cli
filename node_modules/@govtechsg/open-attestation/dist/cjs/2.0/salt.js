...
var recursivelyApply = function (iteratee) { return function (value) {
    if ((0, lodash_1.includes)(PRIMITIVE_TYPES, typeof value) || value === null) {
        return iteratee(value);
    }
    return (0, exports.deepMap)(value, iteratee); // eslint-disable-line @typescript-eslint/no-use-before-define
}; };
/**
...
var deepMap = function (collection, iteratee) {
    ...
    if (collection instanceof Array) {
        return (0, lodash_1.map)(collection, recursivelyApply(iteratee));
    }
    if (typeof collection === "object") {
        return (0, lodash_1.mapValues)(collection, recursivelyApply(iteratee));
    }
    return collection;
};
...
var startsWithUuidV4 = function (input) {
    if (input && typeof input === "string") {
        ...
        return (0, isUUID_1.default)(elements[0], 4);
    }
    return false;
};
/**
...
var saltData = function (data) { return (0, exports.deepMap)(data, uuidSalt); };
exports.saltData = saltData;
var unsaltData = function (data) { return (0, exports.deepMap)(data, unsalt); };
