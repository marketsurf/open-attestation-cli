    ...
    return __generator(this, function (_d) {
        switch (_d.label) {
            case 0:
                ...
                return [4 /*yield*/, (0, signer_1.sign)(algorithm, merkleRoot, keyOrSigner)];
            case 1:
                signature = _d.sent();
                _c = {
            ...
            case 4:
                proof = (_c.verificationMethod = _a,
                    ...
                    _c);
                return [2 /*return*/, __assign(__assign({}, document), { proof: (0, utils_1.isSignedWrappedV2Document)(document) ? __spreadArray(__spreadArray([], document.proof, true), [proof], false) : [proof] })];
        }
    });
}); };
