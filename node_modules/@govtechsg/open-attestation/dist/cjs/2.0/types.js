...
exports.ObfuscationMetadata = (0, runtypes_1.Partial)({
    obfuscatedData: (0, runtypes_1.Array)(document_1.OpenAttestationHexString),
});
exports.Proof = (0, runtypes_1.Record)({
...
exports.ArrayProof = (0, runtypes_1.Array)(exports.Proof);
exports.Signature = (0, runtypes_1.Record)({
    type: (0, runtypes_1.Literal)("SHA3MerkleProof"),
    targetHash: runtypes_1.String,
    merkleRoot: runtypes_1.String,
    proof: (0, runtypes_1.Array)(runtypes_1.String),
});
exports.SignatureStrict = exports.Signature.And((0, runtypes_1.Record)({
    targetHash: document_1.OpenAttestationHexString,
    merkleRoot: document_1.OpenAttestationHexString,
    proof: (0, runtypes_1.Array)(document_1.OpenAttestationHexString),
}));
