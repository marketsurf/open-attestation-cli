...
var wrapDocument = function (data, options) {
    ...
    var errors = (0, validate_1.validateSchema)(document, (0, ajv_1.getSchema)((_a = options === null || options === void 0 ? void 0 : options.version) !== null && _a !== void 0 ? _a : document_1.SchemaId.v2));
    if (errors.length > 0) {
        throw new utils_1.SchemaValidationError("Invalid document", errors, document);
    }
    var digest = (0, digest_1.digestDocument)(document);
    var signature = {
...
var wrapDocuments = function (data, options) {
    ...
    var documents = data.map(function (d) { return (0, exports.wrapDocument)(d, options); });
    ...
    return documents.map(function (document) {
        var merkleProof = merkleTree
            .getProof((0, utils_1.hashToBuffer)(document.signature.targetHash))
