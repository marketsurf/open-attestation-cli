...
var digestCredential = function (document, salts, obfuscatedData) {
    ...
    var hashedUnhashedDataArray = salts
        .filter(function (salt) { return (0, lodash_1.get)(document, salt.path); })
        .map(function (salt) {
        var _a;
        return (0, js_sha3_1.keccak256)(JSON.stringify((_a = {}, _a[salt.path] = salt.value + ":" + (0, lodash_1.get)(document, salt.path), _a)));
    });
