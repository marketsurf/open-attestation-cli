...
exports.ObfuscationMetadata = (0, runtypes_1.Record)({
    obfuscated: (0, runtypes_1.Array)(document_1.OpenAttestationHexString),
});
exports.VerifiableCredentialWrappedProof = (0, runtypes_1.Record)({
    type: document_1.SignatureAlgorithm,
    targetHash: runtypes_1.String,
    merkleRoot: runtypes_1.String,
    proofs: (0, runtypes_1.Array)(runtypes_1.String),
    salts: runtypes_1.String,
    privacy: exports.ObfuscationMetadata,
    proofPurpose: document_1.ProofPurpose,
});
exports.VerifiableCredentialWrappedProofStrict = exports.VerifiableCredentialWrappedProof.And((0, runtypes_1.Record)({
    targetHash: document_1.OpenAttestationHexString,
    merkleRoot: document_1.OpenAttestationHexString,
    proofs: (0, runtypes_1.Array)(document_1.OpenAttestationHexString),
}));
exports.VerifiableCredentialSignedProof = exports.VerifiableCredentialWrappedProof.And((0, runtypes_1.Record)({
