...
var jsonld_1 = require("@govtechsg/jsonld");
            ...
            case 0:
                if (preload) {
                    ...
                    for (_i = 0, preloadedContextList_1 = preloadedContextList; _i < preloadedContextList_1.length; _i++) {
                        ...
                        contexts.set(url_1, (0, cross_fetch_1.default)(url_1, { headers: { accept: "application/json" } }).then(function (res) { return res.json(); }));
                    }
                }
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, (0, jsonld_1.expand)(credential, {
