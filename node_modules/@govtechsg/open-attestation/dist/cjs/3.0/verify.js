...
var verify = function (document) {
    ...
    var decodedSalts = (0, salt_1.decodeSalt)(document.proof.salts);
    // Checks to ensure there are no added/removed values, so visibleSalts.length must match decodedSalts.length
    var visibleSalts = (0, salt_1.salt)(documentWithoutProof);
    if (visibleSalts.length !== decodedSalts.length)
        return false;
    // Checks target hash
    var digest = (0, digest_1.digestCredential)(documentWithoutProof, decodedSalts, document.proof.privacy.obfuscated);
    ...
    return (0, merkle_1.checkProof)(document.proof.proofs, document.proof.merkleRoot, document.proof.targetHash);
};
