    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                salts = (0, salt_1.salt)(document);
                digest = (0, digest_1.digestCredential)(document, salts, []);
                ...
                merkleProof = merkleTree.getProof((0, utils_1.hashToBuffer)(digest)).map(function (buffer) { return buffer.toString("hex"); });
                verifiableCredential = __assign(__assign({}, document), { proof: {
                        ...
                        salts: (0, salt_1.encodeSalt)(salts),
                        privacy: {
                            obfuscated: [],
                        },
                    } });
                errors = (0, validate_1.validateSchema)(verifiableCredential, (0, ajv_1.getSchema)(document_1.SchemaId.v3));
                if (errors.length > 0) {
                    throw new utils_1.SchemaValidationError("Invalid document", errors, verifiableCredential);
                }
                return [4 /*yield*/, (0, validate_2.validateW3C)(verifiableCredential)];
            case 1:
                _a.sent();
...
var wrapDocuments = function (documents, options) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, Promise.all(documents.map(function (document) { return (0, exports.wrapDocument)(document, options); }))];
            case 1:
                ...
                return [2 /*return*/, verifiableCredentials.map(function (verifiableCredential) {
                        ...
                        var merkleProof = merkleTree.getProof((0, utils_1.hashToBuffer)(digest)).map(function (buffer) { return buffer.toString("hex"); });
