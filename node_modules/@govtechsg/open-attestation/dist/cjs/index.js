...
function __unsafe__use__it__at__your__own__risks__wrapDocument(data, options) {
    return (0, wrap_2.wrapDocument)(data, options !== null && options !== void 0 ? options : { version: document_1.SchemaId.v3 });
}
...
function __unsafe__use__it__at__your__own__risks__wrapDocuments(dataArray, options) {
    return (0, wrap_2.wrapDocuments)(dataArray, options !== null && options !== void 0 ? options : { version: document_1.SchemaId.v3 });
}
...
function wrapDocument(data, options) {
    return (0, wrap_1.wrapDocument)(data, { externalSchemaId: options === null || options === void 0 ? void 0 : options.externalSchemaId });
}
exports.wrapDocument = wrapDocument;
function wrapDocuments(dataArray, options) {
    return (0, wrap_1.wrapDocuments)(dataArray, { externalSchemaId: options === null || options === void 0 ? void 0 : options.externalSchemaId });
}
exports.wrapDocuments = wrapDocuments;
var validateSchema = function (document) {
    return (0, validate_1.validateSchema)(document, (0, ajv_1.getSchema)("" + ((document === null || document === void 0 ? void 0 : document.version) || document_1.SchemaId.v2))).length === 0;
};
exports.validateSchema = validateSchema;
function verifySignature(document) {
    return utils.isWrappedV3Document(document) ? (0, verify_2.verify)(document) : (0, verify_1.verify)(document);
}
exports.verifySignature = verifySignature;
function obfuscate(document, fields) {
    return document.version === document_1.SchemaId.v3
        ? (0, obfuscate_2.obfuscateVerifiableCredential)(document, fields)
        : (0, obfuscate_1.obfuscateDocument)(document, fields);
}
        ...
        return __generator(this, function (_a) {
            ...
            switch (true) {
                case utils.isWrappedV2Document(document):
                    return [2 /*return*/, (0, sign_1.signDocument)(document, algorithm, keyOrSigner)];
                case utils.isWrappedV3Document(document):
                    return [2 /*return*/, (0, sign_2.signDocument)(document, algorithm, keyOrSigner)];
                default:
