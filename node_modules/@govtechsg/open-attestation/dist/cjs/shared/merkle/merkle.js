...
function getNextLayer(elements) {
    return elements.reduce(function (layer, element, index, arr) {
        if (index % 2 === 0) {
            ...
            layer.push((0, utils_1.combineHashBuffers)(element, arr[index + 1]));
        }
        return layer;
    }, []);
}
...
var MerkleTree = /** @class */ (function () {
    function MerkleTree(_elements) {
        this.elements = (0, utils_1.hashArray)(_elements);
        // check buffers
    ...
    MerkleTree.prototype.getProof = function (_element) {
        var element = (0, utils_1.toBuffer)(_element);
...
var checkProof = function (_proof, _root, _element) {
    var proof = _proof.map(function (step) { return (0, utils_1.hashToBuffer)(step); });
    var root = (0, utils_1.hashToBuffer)(_root);
    var element = (0, utils_1.hashToBuffer)(_element);
    var proofRoot = proof.reduce(function (hash, pair) { return (0, utils_1.combineHashBuffers)(hash, pair); }, element);
