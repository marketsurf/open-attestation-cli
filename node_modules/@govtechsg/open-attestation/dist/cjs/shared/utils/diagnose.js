...
function transformSchema(schema) {
    ...
    function omit(value) {
        if (value && typeof value === "object") {
            ...
            if (key) {
                var node_1 = (0, lodash_1.clone)(value);
    ...
    var newSchema = (0, lodash_1.cloneDeepWith)(schema, omit);
...
var ajv = (0, ajv_1.buildAjv)({ transform: transformSchema, validateFormats: false });
/**
...
var diagnose = function (_a) {
    ...
    var errors = (0, validate_1.validateSchema)(document, (0, ajv_1.getSchema)(version === "3.0" ? document_1.SchemaId.v3 : document_1.SchemaId.v2, mode === "non-strict" ? ajv : undefined), kind);
    if (errors.length > 0) {
        // TODO this can be improved later
        return handleError.apply(void 0, __spreadArray([debug, "The document does not match OpenAttestation schema " + (version === "3.0" ? "3.0" : "2.0")], errors.map(function (error) { return (error.instancePath || "document") + " - " + error.message; }), false));
    }
    if (kind === "raw") {
        return [];
    }
...
var diagnoseV3 = function (_a) {
    var kind = _a.kind, document = _a.document, debug = _a.debug, mode = _a.mode;
    if (document.version !== document_1.SchemaId.v3) {
        return handleError(debug, "The document schema version is wrong. Expected " + document_1.SchemaId.v3 + ", received " + document.version);
    }
    try {
        // eslint-disable-next-line @typescript-eslint/no-unused-expressions
        mode === "strict"
