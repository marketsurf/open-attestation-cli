...
exports.getObfuscatedData = exports.isObfuscated = exports.keccak256 = exports.isSchemaValidationError = exports.SchemaValidationError = exports.getAssetId = exports.isDocumentRevokable = exports.isTransferableAsset = exports.getDocumentData = exports.getTemplateURL = exports.getTargetHash = exports.getMerkleRoot = exports.getIssuerAddress = exports.combineHashString = exports.combineHashBuffers = exports.hashArray = exports.toBuffer = exports.hashToBuffer = exports.bufSortJoin = exports.getData = void 0;
var js_sha3_1 = require("js-sha3");
var salt_1 = require("../../2.0/salt");
var guard_1 = require("./guard");
var getData = function (document) {
    return (0, salt_1.unsaltData)(document.data);
};
...
function toBuffer(element) {
    return Buffer.isBuffer(element) && element.length === 32 ? element : hashToBuffer((0, js_sha3_1.keccak256)(JSON.stringify(element)));
}
...
function combineHashBuffers(first, second) {
    ...
    return hashToBuffer((0, js_sha3_1.keccak256)(bufSortJoin(first, second)));
}
...
function getIssuerAddress(document) {
    if ((0, guard_1.isWrappedV2Document)(document)) {
        var data = (0, exports.getData)(document);
        return data.issuers.map(function (issuer) { return issuer.certificateStore || issuer.documentStore || issuer.tokenRegistry; });
    }
    else if ((0, guard_1.isWrappedV3Document)(document)) {
...
var getMerkleRoot = function (document) {
    switch (true) {
        case (0, guard_1.isWrappedV2Document)(document):
            return document.signature.merkleRoot;
        case (0, guard_1.isWrappedV3Document)(document):
...
var getTemplateURL = function (document) {
    switch (true) {
        case (0, guard_1.isWrappedV2Document)(document):
            return (0, exports.getData)(document).$template.url;
        case (0, guard_1.isRawV2Document)(document):
            return document.$template.url;
        case (0, guard_1.isRawV3Document)(document) || (0, guard_1.isWrappedV3Document)(document):
...
var getDocumentData = function (document) {
    if ((0, guard_1.isWrappedV3Document)(document)) {
    ...
    else if ((0, guard_1.isWrappedV2Document)(document)) {
        return (0, exports.getData)(document);
    }
    else {
...
var isTransferableAsset = function (document) {
    var _a, _b, _c, _d;
    return (!!((_b = (_a = (0, exports.getData)(document)) === null || _a === void 0 ? void 0 : _a.issuers[0]) === null || _b === void 0 ? void 0 : _b.tokenRegistry) ||
...
var isDocumentRevokable = function (document) {
    var _a, _b, _c;
    switch (true) {
        case (0, exports.isTransferableAsset)(document):
            return false;
        case (0, guard_1.isWrappedV2Document)(document):
            var issuer = (_a = (0, exports.getData)(document)) === null || _a === void 0 ? void 0 : _a.issuers[0];
...
var getAssetId = function (document) {
    if ((0, exports.isTransferableAsset)(document)) {
        return (0, exports.getTargetHash)(document);
    }
