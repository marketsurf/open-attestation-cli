(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('debug'), require('runtypes'), require('ethers'), require('js-sha3'), require('lodash'), require('validator/lib/isUUID'), require('uuid'), require('ajv'), require('ajv-formats'), require('flatley'), require('crypto'), require('js-base64'), require('@govtechsg/jsonld'), require('cross-fetch')) :
    typeof define === 'function' && define.amd ? define(['exports', 'debug', 'runtypes', 'ethers', 'js-sha3', 'lodash', 'validator/lib/isUUID', 'uuid', 'ajv', 'ajv-formats', 'flatley', 'crypto', 'js-base64', '@govtechsg/jsonld', 'cross-fetch'], factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.openAttestation = {}, global.debug, global.runtypes, global.ethers, global.jsSha3, global.lodash, global.isUUID, global.uuid, global.Ajv, global.addFormats, global.flatley, global.crypto, global.jsBase64, global.jsonld, global.fetch));
})(this, (function (exports, debug, runtypes, ethers, jsSha3, lodash, isUUID, uuid, Ajv, addFormats, flatley, crypto, jsBase64, jsonld, fetch) { 'use strict';
    ...
    var diagnose = function (_a) {
        ...
        var errors = validateSchema$1(document, getSchema(version === "3.0" ? exports.SchemaId.v3 : exports.SchemaId.v2, mode === "non-strict" ? ajv : undefined), kind);
        if (errors.length > 0) {
            // TODO this can be improved later
            return handleError.apply(void 0, __spreadArray$2([debug, "The document does not match OpenAttestation schema " + (version === "3.0" ? "3.0" : "2.0")], errors.map(function (error) { return (error.instancePath || "document") + " - " + error.message; }), false));
        }
        if (kind === "raw") {
            return [];
        }
     ...
     * @param mode strict or non-strict. Strict will perform additional check on the data. For instance strict validation will ensure that a target hash is a 32 bytes hex string while non strict validation will just check that target hash is a string.
     */
    var isRawV2Document = function (document, _a) {
        var _b = _a === void 0 ? { mode: "non-strict" } : _a, mode = _b.mode;
        return diagnose({ version: "2.0", kind: "raw", document: document, debug: false, mode: mode }).length === 0;
    };
    /**
     *
     * @param document
     * @param mode strict or non-strict. Strict will perform additional check on the data. For instance strict validation will ensure that a target hash is a 32 bytes hex string while non strict validation will just check that target hash is a string.
     */
    var isRawV3Document = function (document, _a) {
        var _b = _a === void 0 ? { mode: "non-strict" } : _a, mode = _b.mode;
        return diagnose({ version: "3.0", kind: "raw", document: document, debug: false, mode: mode }).length === 0;
    };
    /**
     *
     * @param document
    ...
    function bufSortJoin() {
        ...
        return Buffer.concat(__spreadArray$1([], args, true).sort(Buffer.compare));
    }
    ...
    var getTemplateURL = function (document) {
        switch (true) {
            case isWrappedV2Document(document):
                return getData(document).$template.url;
    ...
    var getDocumentData = function (document) {
    ...
    var isDocumentRevokable = function (document) {
        var _a, _b, _c;
        switch (true) {
            case isTransferableAsset(document):
                return false;
            case isWrappedV2Document(document):
                var issuer = (_a = getData(document)) === null || _a === void 0 ? void 0 : _a.issuers[0];
                return !!issuer.certificateStore || !!issuer.documentStore || ((_b = issuer.revocation) === null || _b === void 0 ? void 0 : _b.type) === "REVOCATION_STORE";
            case isWrappedV3Document(document):
                var isDidRevokable = document.openAttestationMetadata.proof.method === "DID" &&
                    ((_c = document.openAttestationMetadata.proof.revocation) === null || _c === void 0 ? void 0 : _c.type) === "REVOCATION_STORE";
                var isDocumentStoreRevokable = document.openAttestationMetadata.proof.method === "DOCUMENT_STORE" &&
    ...
    var validateSchema$1 = function (document, validator, kind) {
        var _a;
        if (!validator) {
            throw new Error("No schema validator provided");
        }
        var valid = validator(document.version === exports.SchemaId.v3 || kind === "raw" ? document : getData(document));
        if (!valid) {
    ...
    var index = /*#__PURE__*/Object.freeze({
        ...
        isDocumentRevokable: isDocumentRevokable,
        getAssetId: getAssetId,
        SchemaValidationError: SchemaValidationError,
        isSchemaValidationError: isSchemaValidationError$1,
        isObfuscated: isObfuscated,
        getObfuscatedData: getObfuscatedData,
        isRawV2Document: isRawV2Document,
        isRawV3Document: isRawV3Document,
    ...
    var signerBuilder = function (signers) {
        return function (alg, message, keyOrSigner, options) {
            ...
            switch (_d.label) {
                ...
                case 4:
                    proof = (_c.verificationMethod = _a,
                        ...
                        _c);
                    return [2 /*return*/, __assign$4(__assign$4({}, document), { proof: isSignedWrappedV2Document(document) ? __spreadArray(__spreadArray([], document.proof, true), [proof], false) : [proof] })];
            }
        });
    }); };
