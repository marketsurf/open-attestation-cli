...
export declare const getTemplateURL: (document: any) => string | undefined;
export declare const getDocumentData: (document: WrappedDocument<OpenAttestationDocument>) => OpenAttestationDocument;
export declare const isTransferableAsset: (document: any) => boolean;
export declare const isDocumentRevokable: (document: any) => boolean;
