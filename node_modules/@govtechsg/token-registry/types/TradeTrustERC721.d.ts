...
interface TradeTrustERC721Interface extends ethers.utils.Interface {
  functions: {
    ...
    "sendToNewTitleEscrow(address,address,uint256)": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "sendToNewTitleEscrow",
    values: [string, string, BigNumberish]
  ): string;
  encodeFunctionData(
...
export class TradeTrustERC721 extends Contract {
  ...
  functions: {
    ...
    "sendToNewTitleEscrow(address,address,uint256)"(
      beneficiary: string,
      holder: string,
      _tokenId: BigNumberish,
      overrides?: Overrides
